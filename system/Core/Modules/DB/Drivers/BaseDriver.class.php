...
abstract class BaseDriver {
	...
	protected function parseColumns($columns){
		return implode(',', array_map( array($this, 'escape'), $columns));
	}
	...
	protected function parseValuesForUpdate($values){
		if (is_array($values)){
			$valstr = '';
	...
	abstract public function insert($table, Array $columns, Array $values);
