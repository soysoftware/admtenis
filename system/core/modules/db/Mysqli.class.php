<?php
class Core_Modules_DB_Mysql extends Core_Modules_DB_DB {
	
	const MYSQL_DEFAULT_PORT = 3306;
	
	private $transactionLevel = 0;
	
	public function __construct($host, $user, $pass, $database = '', $port = self::MYSQL_DEFAULT_PORT, $autoConnect = false){
